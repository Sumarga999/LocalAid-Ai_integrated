    ...
    <div className="bg-surface font-body-md text-on-surface">
      ...
      {/* <header className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm shadow-sm sticky top-0 z-50 border-b border-slate-100 dark:border-slate-800">
        <div className="flex justify-between items-center w-full px-6 py-4 max-w-7xl mx-auto">
          <div className="text-2xl font-extrabold text-green-800 dark:text-green-400 tracking-tight font-headline-lg">
            LocalAid
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/signup" className="bg-secondary-container hover:bg-secondary text-on-secondary-container px-12 py-5 rounded-xl font-headline-md text-headline-md shadow-xl transition-all hover:-translate-y-1 active:scale-95 inline-block text-center">Sign Up Now</Link>
            </div>
        </div>
      </header> */}
      ...
      {/* Footer */}
      {/* <footer className="bg-green-900 dark:bg-black text-white py-12 md:py-16 border-t border-green-800 dark:border-slate-800">
