      ...
      <header className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm shadow-sm sticky top-0 z-50 border-b border-slate-100 dark:border-slate-800">
        <div className="flex justify-between items-center w-full px-6 py-4 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="bg-primary hover:bg-primary-container text-white px-6 py-2.5 rounded-lg font-label-md transition-transform active:scale-95 duration-150 shadow-sm">Get Started</button>
          </div>
        </div>
      </header>
